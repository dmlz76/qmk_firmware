...
[1] = LAYOUT(
    KC_PAUSE, KC_WWW_BACK, KC_WWW_FORWARD, KC_WWW_REFRESH, KC_TRNS, KC_MISSION_CONTROL, KC_BRIGHTNESS_DOWN, KC_BRIGHTNESS_UP, KC_AUDIO_MUTE, KC_AUDIO_VOL_DOWN, KC_AUDIO_VOL_UP, KC_SYSTEM_POWER, KC_PRINT_SCREEN, KC_DEL, 
